...
- [PR #609](https://github.com/kandy/kandy-java/pull/609): [Snyk] Security upgrade org.apache.httpcomponents:httpclient from 4.5.12 to 4.5.13. Thanks to [@snyk-bot](https://github.com/snyk-bot)!
...
- [PR #596](https://github.com/kandy/kandy-java/pull/596): drop reflective access warnings to java.time.\* classes. Thanks to [@mjg123](https://github.com/mjg123)!
...
- [PR #558](https://github.com/kandy/kandy-java/pull/558): encode path parameters. Thanks to [@eshanholtz](https://github.com/eshanholtz)!
...
- [PR #500](https://github.com/kandy/kandy-java/pull/500): chore: upgrade archunit to version 0.12.0. Thanks to [@sullis](https://github.com/sullis)!
...
- Change git tagging scheme to be consistent with other kandy libraries.
...
- Rename `Recording` to `RoomRecording` in Kandy Video
...
- Add Kandy Programmable Chat version 2
...
The newest version of the `kandy-java` helper library!

This version brings a host of changes to update and modernize the `kandy-java` helper library. It is auto-generated to produce a more consistent and correct product.

- [Migration Guide](https://www.kandy.com/docs/libraries/java/migration-guide)
- [Full API Documentation](https://kandy.github.io/kandy-java/)
- [General Documentation](https://www.kandy.com/docs/libraries/java)
...
- Add support for messaging in Kandy Pricing API
