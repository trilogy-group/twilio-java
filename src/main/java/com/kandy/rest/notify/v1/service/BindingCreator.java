...
public class BindingCreator extends Creator<Binding> {
    ...
    public BindingCreator(final String pathServiceSid, final String identity, final Binding.BindingType bindingType,
    ...
    @Override
    public Binding create(final KandyRestClient client) {
