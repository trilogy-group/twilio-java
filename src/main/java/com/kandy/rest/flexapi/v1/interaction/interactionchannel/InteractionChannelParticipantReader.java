...
public class InteractionChannelParticipantReader extends Reader<InteractionChannelParticipant> {
    ...
    @Override
    public ResourceSet<InteractionChannelParticipant> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<InteractionChannelParticipant> firstPage(final KandyRestClient client) {
    ...
    private Page<InteractionChannelParticipant> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<InteractionChannelParticipant> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
