...
public class InsightsQuestionnairesQuestion extends Resource {
    ...
    public static InsightsQuestionnairesQuestionCreator creator(final String categorySid, final String question,
            final String answerSetId, final Boolean allowNa) {
    ...
    /**
     * Converts a JSON String into a InsightsQuestionnairesQuestion object using the
     * provided ObjectMapper.
     *
     * @param json         Raw JSON String
     * @param objectMapper Jackson ObjectMapper
     * @return InsightsQuestionnairesQuestion object represented by the provided
     *         JSON
     */
    ...
    /**
     * Converts a JSON InputStream into a InsightsQuestionnairesQuestion object
     * using the provided
     * ObjectMapper.
     *
    ...
    public boolean equals(final Object o) {
        ...
        return Objects.equals(accountSid, other.accountSid) && Objects.equals(questionSid, other.questionSid)
                && Objects.equals(question, other.question) && Objects.equals(description, other.description)
                && Objects.equals(category, other.category) && Objects.equals(answerSetId, other.answerSetId)
                && Objects.equals(allowNa, other.allowNa) && Objects.equals(usage, other.usage)
                && Objects.equals(answerSet, other.answerSet) && Objects.equals(url, other.url);
    }

    @Override
    public int hashCode() {
        return Objects.hash(accountSid, questionSid, question, description, category, answerSetId, allowNa, usage,
                answerSet, url);
    }
