...
public class Configuration extends Resource {
    ...
    private Configuration(
            ...
            @JsonProperty("taskrouter_taskqueues") final List<Map<String, Object>> taskrouterTaskqueues,

            @JsonProperty("taskrouter_skills") final List<Map<String, Object>> taskrouterSkills,

            @JsonProperty("taskrouter_worker_channels") final Map<String, Object> taskrouterWorkerChannels,

            @JsonProperty("taskrouter_worker_attributes") final Map<String, Object> taskrouterWorkerAttributes,
            ...
            @JsonProperty("ui_dependencies") final Map<String, Object> uiDependencies,
            ...
            @JsonProperty("call_recording_webhook_url") final URI callRecordingWebhookUrl,
            ...
            @JsonProperty("public_attributes") final Map<String, Object> publicAttributes,

            @JsonProperty("plugin_service_enabled") final Boolean pluginServiceEnabled,

            @JsonProperty("plugin_service_attributes") final Map<String, Object> pluginServiceAttributes,

            @JsonProperty("integrations") final List<Map<String, Object>> integrations,

            @JsonProperty("outbound_call_flows") final Map<String, Object> outboundCallFlows,

            @JsonProperty("serverless_service_sids") final List<String> serverlessServiceSids,

            @JsonProperty("queue_stats_configuration") final Map<String, Object> queueStatsConfiguration,
            ...
            @JsonProperty("flex_insights_hr") final Map<String, Object> flexInsightsHr,

            @JsonProperty("flex_insights_drilldown") final Boolean flexInsightsDrilldown,

            @JsonProperty("flex_url") final URI flexUrl,

            @JsonProperty("channel_configs") final List<Map<String, Object>> channelConfigs,

            @JsonProperty("debugger_integration") final Map<String, Object> debuggerIntegration,

            @JsonProperty("flex_ui_status_report") final Map<String, Object> flexUiStatusReport) {
    ...
    public boolean equals(final Object o) {
        ...
        return Objects.equals(accountSid, other.accountSid) && Objects.equals(dateCreated, other.dateCreated)
                && Objects.equals(dateUpdated, other.dateUpdated) && Objects.equals(attributes, other.attributes)
                ...
                && Objects.equals(uiLanguage, other.uiLanguage) && Objects.equals(uiAttributes, other.uiAttributes)
                && Objects.equals(uiDependencies, other.uiDependencies) && Objects.equals(uiVersion, other.uiVersion)
                ...
                && Objects.equals(crmEnabled, other.crmEnabled) && Objects.equals(crmType, other.crmType)
                ...
                && Objects.equals(notifications, other.notifications) && Objects.equals(markdown, other.markdown)
                && Objects.equals(url, other.url) && Objects.equals(flexInsightsHr, other.flexInsightsHr)
                && Objects.equals(flexInsightsDrilldown, other.flexInsightsDrilldown)
                && Objects.equals(flexUrl, other.flexUrl) && Objects.equals(channelConfigs, other.channelConfigs)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(accountSid, dateCreated, dateUpdated, attributes, status, taskrouterWorkspaceSid,
                taskrouterTargetWorkflowSid, taskrouterTargetTaskqueueSid, taskrouterTaskqueues, taskrouterSkills,
                taskrouterWorkerChannels, taskrouterWorkerAttributes, taskrouterOfflineActivitySid, runtimeDomain,
                messagingServiceInstanceSid, chatServiceInstanceSid, flexServiceInstanceSid, uiLanguage, uiAttributes,
                uiDependencies, uiVersion, serviceVersion, callRecordingEnabled, callRecordingWebhookUrl, crmEnabled,
                crmType, crmCallbackUrl, crmFallbackUrl, crmAttributes, publicAttributes, pluginServiceEnabled,
                pluginServiceAttributes, integrations, outboundCallFlows, serverlessServiceSids,
                queueStatsConfiguration, notifications, markdown, url, flexInsightsHr, flexInsightsDrilldown, flexUrl,
                channelConfigs, debuggerIntegration, flexUiStatusReport);
    }
