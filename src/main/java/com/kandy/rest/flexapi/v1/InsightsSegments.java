...
public class InsightsSegments extends Resource {
    ...
    /**
     * Converts a JSON String into a InsightsSegments object using the provided
     * ObjectMapper.
     *
    ...
    private InsightsSegments(
            ...
            @JsonProperty("assessment_type") final Map<String, Object> assessmentType,

            @JsonProperty("assessment_percentage") final Map<String, Object> assessmentPercentage,
    ...
    public boolean equals(final Object o) {
        ...
        return Objects.equals(segmentId, other.segmentId) && Objects.equals(externalId, other.externalId)
                && Objects.equals(queue, other.queue) && Objects.equals(externalContact, other.externalContact)
                && Objects.equals(externalSegmentLinkId, other.externalSegmentLinkId)
                && Objects.equals(date, other.date) && Objects.equals(accountId, other.accountId)
                && Objects.equals(externalSegmentLink, other.externalSegmentLink)
                && Objects.equals(agentId, other.agentId) && Objects.equals(agentPhone, other.agentPhone)
                && Objects.equals(agentName, other.agentName) && Objects.equals(agentTeamName, other.agentTeamName)
                && Objects.equals(agentTeamNameInHierarchy, other.agentTeamNameInHierarchy)
                && Objects.equals(agentLink, other.agentLink) && Objects.equals(customerPhone, other.customerPhone)
                && Objects.equals(customerName, other.customerName) && Objects.equals(customerLink, other.customerLink)
                && Objects.equals(segmentRecordingOffset, other.segmentRecordingOffset)
                && Objects.equals(media, other.media) && Objects.equals(assessmentType, other.assessmentType)
                && Objects.equals(assessmentPercentage, other.assessmentPercentage) && Objects.equals(url, other.url);
    }

    @Override
    public int hashCode() {
        return Objects.hash(segmentId, externalId, queue, externalContact, externalSegmentLinkId, date, accountId,
                externalSegmentLink, agentId, agentPhone, agentName, agentTeamName, agentTeamNameInHierarchy, agentLink,
                customerPhone, customerName, customerLink, segmentRecordingOffset, media, assessmentType,
                assessmentPercentage, url);
    }
