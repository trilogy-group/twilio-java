...
public class InteractionChannelReader extends Reader<InteractionChannel> {
    ...
    @Override
    public ResourceSet<InteractionChannel> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<InteractionChannel> firstPage(final KandyRestClient client) {
    ...
    private Page<InteractionChannel> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<InteractionChannel> previousPage(final Page<InteractionChannel> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<InteractionChannel> nextPage(final Page<InteractionChannel> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<InteractionChannel> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
