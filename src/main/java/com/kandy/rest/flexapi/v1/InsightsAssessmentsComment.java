...
public class InsightsAssessmentsComment extends Resource {
    ...
    public static InsightsAssessmentsCommentCreator creator(final String categoryId, final String categoryName,
            final String comment, final String segmentId, final String agentId, final BigDecimal offset) {
    ...
    /**
     * Converts a JSON String into a InsightsAssessmentsComment object using the
    ...
    /**
     * Converts a JSON InputStream into a InsightsAssessmentsComment object using
     * the provided
     * ObjectMapper.
     *
    ...
    public boolean equals(final Object o) {
        ...
        return Objects.equals(accountSid, other.accountSid) && Objects.equals(assessmentSid, other.assessmentSid)
                && Objects.equals(comment, other.comment) && Objects.equals(offset, other.offset)
                && Objects.equals(report, other.report) && Objects.equals(weight, other.weight)
                && Objects.equals(agentId, other.agentId) && Objects.equals(segmentId, other.segmentId)
                && Objects.equals(userName, other.userName) && Objects.equals(userEmail, other.userEmail)
                && Objects.equals(timestamp, other.timestamp) && Objects.equals(url, other.url);
    }

    @Override
    public int hashCode() {
        return Objects.hash(accountSid, assessmentSid, comment, offset, report, weight, agentId, segmentId, userName,
                userEmail, timestamp, url);
    }
