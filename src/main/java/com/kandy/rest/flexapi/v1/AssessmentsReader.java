...
public class AssessmentsReader extends Reader<Assessments> {
    ...
    @Override
    public ResourceSet<Assessments> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Assessments> firstPage(final KandyRestClient client) {
    ...
    private Page<Assessments> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Assessments> previousPage(final Page<Assessments> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Assessments> nextPage(final Page<Assessments> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Assessments> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
