...
public class InteractionChannelParticipantCreator extends Creator<InteractionChannelParticipant> {
    ...
    public InteractionChannelParticipantCreator(final String pathInteractionSid, final String pathChannelSid,
            final InteractionChannelParticipant.Type type, final Map<String, Object> mediaProperties) {
    ...
    @Override
    public InteractionChannelParticipant create(final KandyRestClient client) {
