...
public class InsightsQuestionnairesReader extends Reader<InsightsQuestionnaires> {
    ...
    @Override
    public ResourceSet<InsightsQuestionnaires> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<InsightsQuestionnaires> firstPage(final KandyRestClient client) {
    ...
    private Page<InsightsQuestionnaires> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<InsightsQuestionnaires> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
