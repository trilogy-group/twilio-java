...
public class InsightsConversationsReader extends Reader<InsightsConversations> {
    ...
    @Override
    public ResourceSet<InsightsConversations> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<InsightsConversations> firstPage(final KandyRestClient client) {
    ...
    private Page<InsightsConversations> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<InsightsConversations> previousPage(final Page<InsightsConversations> page,
    ...
    @Override
    public Page<InsightsConversations> nextPage(final Page<InsightsConversations> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<InsightsConversations> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
