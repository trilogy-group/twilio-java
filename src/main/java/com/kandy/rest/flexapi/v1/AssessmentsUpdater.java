...
public class AssessmentsUpdater extends Updater<Assessments> {
    ...
    public AssessmentsUpdater(final String pathAssessmentSid, final BigDecimal offset, final String answerText,
    ...
    @Override
    public Assessments update(final KandyRestClient client) {
