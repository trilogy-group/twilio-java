...
public class InsightsAssessmentsCommentCreator extends Creator<InsightsAssessmentsComment> {
    ...
    public InsightsAssessmentsCommentCreator(final String categoryId, final String categoryName, final String comment,
            final String segmentId, final String agentId, final BigDecimal offset) {
    ...
    @Override
    public InsightsAssessmentsComment create(final KandyRestClient client) {
