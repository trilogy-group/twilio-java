...
public class InteractionChannelInviteReader extends Reader<InteractionChannelInvite> {
    ...
    @Override
    public ResourceSet<InteractionChannelInvite> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<InteractionChannelInvite> firstPage(final KandyRestClient client) {
    ...
    private Page<InteractionChannelInvite> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<InteractionChannelInvite> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
