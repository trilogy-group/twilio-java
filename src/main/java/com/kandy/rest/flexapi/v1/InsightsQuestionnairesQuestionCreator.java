...
public class InsightsQuestionnairesQuestionCreator extends Creator<InsightsQuestionnairesQuestion> {
    ...
    public InsightsQuestionnairesQuestionCreator(final String categorySid, final String question,
    ...
    @Override
    public InsightsQuestionnairesQuestion create(final KandyRestClient client) {
