...
public class InsightsQuestionnairesQuestionReader extends Reader<InsightsQuestionnairesQuestion> {
    ...
    @Override
    public ResourceSet<InsightsQuestionnairesQuestion> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<InsightsQuestionnairesQuestion> firstPage(final KandyRestClient client) {
    ...
    private Page<InsightsQuestionnairesQuestion> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<InsightsQuestionnairesQuestion> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
