...
public class CustomerProfiles extends Resource {
    ...
    public static CustomerProfilesCreator creator(final String friendlyName, final String email,
    ...
    public enum Status {
        ...
        IN_REVIEW("in-review"),
        KANDY_REJECTED("kandy-rejected"),
        KANDY_APPROVED("kandy-approved");
    ...
    public boolean equals(final Object o) {
        ...
        return Objects.equals(sid, other.sid) && Objects.equals(accountSid, other.accountSid)
                && Objects.equals(policySid, other.policySid) && Objects.equals(friendlyName, other.friendlyName)
                && Objects.equals(status, other.status) && Objects.equals(validUntil, other.validUntil)
                && Objects.equals(email, other.email) && Objects.equals(statusCallback, other.statusCallback)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(sid, accountSid, policySid, friendlyName, status, validUntil, email, statusCallback,
