...
public class TrustProductsEntityAssignmentsReader extends Reader<TrustProductsEntityAssignments> {
    ...
    @Override
    public ResourceSet<TrustProductsEntityAssignments> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<TrustProductsEntityAssignments> firstPage(final KandyRestClient client) {
    ...
    private Page<TrustProductsEntityAssignments> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<TrustProductsEntityAssignments> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
