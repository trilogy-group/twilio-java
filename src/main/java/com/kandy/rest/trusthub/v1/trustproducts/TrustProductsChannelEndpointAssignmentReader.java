...
public class TrustProductsChannelEndpointAssignmentReader extends Reader<TrustProductsChannelEndpointAssignment> {
    ...
    private Page<TrustProductsChannelEndpointAssignment> pageForRequest(final TwilioRestClient client,
    ...
    public Page<TrustProductsChannelEndpointAssignment> previousPage(
            final Page<TrustProductsChannelEndpointAssignment> page, final TwilioRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
