...
public class TrustProductsChannelEndpointAssignmentReader extends Reader<TrustProductsChannelEndpointAssignment> {
    ...
    @Override
    public ResourceSet<TrustProductsChannelEndpointAssignment> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<TrustProductsChannelEndpointAssignment> firstPage(final KandyRestClient client) {
    ...
    private Page<TrustProductsChannelEndpointAssignment> pageForRequest(final KandyRestClient client,
    ...
    public Page<TrustProductsChannelEndpointAssignment> previousPage(
            final Page<TrustProductsChannelEndpointAssignment> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<TrustProductsChannelEndpointAssignment> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
