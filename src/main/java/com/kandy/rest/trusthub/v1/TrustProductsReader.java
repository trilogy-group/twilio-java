...
public class TrustProductsReader extends Reader<TrustProducts> {
    ...
    @Override
    public ResourceSet<TrustProducts> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<TrustProducts> firstPage(final KandyRestClient client) {
    ...
    private Page<TrustProducts> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<TrustProducts> previousPage(final Page<TrustProducts> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<TrustProducts> nextPage(final Page<TrustProducts> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<TrustProducts> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
