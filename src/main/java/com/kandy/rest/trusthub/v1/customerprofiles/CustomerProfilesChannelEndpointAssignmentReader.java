...
public class CustomerProfilesChannelEndpointAssignmentReader extends Reader<CustomerProfilesChannelEndpointAssignment> {
    ...
    private Page<CustomerProfilesChannelEndpointAssignment> pageForRequest(final TwilioRestClient client,
    ...
    public Page<CustomerProfilesChannelEndpointAssignment> previousPage(
            final Page<CustomerProfilesChannelEndpointAssignment> page, final TwilioRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
