...
public class EventTypeReader extends Reader<EventType> {
    ...
    @Override
    public ResourceSet<EventType> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<EventType> firstPage(final KandyRestClient client) {
    ...
    private Page<EventType> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<EventType> previousPage(final Page<EventType> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<EventType> nextPage(final Page<EventType> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<EventType> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
