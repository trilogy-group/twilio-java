...
public class SinkReader extends Reader<Sink> {
    ...
    @Override
    public ResourceSet<Sink> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Sink> firstPage(final KandyRestClient client) {
    ...
    private Page<Sink> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Sink> previousPage(final Page<Sink> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Sink> nextPage(final Page<Sink> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Sink> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
