...
public class BundleCopyReader extends Reader<BundleCopy> {
    ...
    @Override
    public ResourceSet<BundleCopy> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<BundleCopy> firstPage(final KandyRestClient client) {
    ...
    private Page<BundleCopy> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<BundleCopy> previousPage(final Page<BundleCopy> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<BundleCopy> nextPage(final Page<BundleCopy> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<BundleCopy> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
