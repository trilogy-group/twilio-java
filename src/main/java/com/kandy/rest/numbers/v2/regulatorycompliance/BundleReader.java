...
public class BundleReader extends Reader<Bundle> {
    ...
    @Override
    public ResourceSet<Bundle> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Bundle> firstPage(final KandyRestClient client) {
    ...
    private Page<Bundle> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Bundle> previousPage(final Page<Bundle> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Bundle> nextPage(final Page<Bundle> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Bundle> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
    ...
    private void addQueryParams(final Request request) {
        ...
        if (validUntilDate != null) {
            request.addQueryParam("ValidUntilDate",
                    validUntilDate.format(DateTimeFormatter.ofPattern(Request.QUERY_STRING_DATE_TIME_FORMAT)));
