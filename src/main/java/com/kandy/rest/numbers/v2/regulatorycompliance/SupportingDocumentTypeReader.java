...
public class SupportingDocumentTypeReader extends Reader<SupportingDocumentType> {
    ...
    @Override
    public ResourceSet<SupportingDocumentType> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<SupportingDocumentType> firstPage(final KandyRestClient client) {
    ...
    private Page<SupportingDocumentType> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<SupportingDocumentType> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
