...
public class EvaluationReader extends Reader<Evaluation> {
    ...
    @Override
    public ResourceSet<Evaluation> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Evaluation> firstPage(final KandyRestClient client) {
    ...
    private Page<Evaluation> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Evaluation> previousPage(final Page<Evaluation> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Evaluation> nextPage(final Page<Evaluation> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Evaluation> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
