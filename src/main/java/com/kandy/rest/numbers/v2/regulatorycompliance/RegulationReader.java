...
public class RegulationReader extends Reader<Regulation> {
    ...
    @Override
    public ResourceSet<Regulation> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Regulation> firstPage(final KandyRestClient client) {
    ...
    private Page<Regulation> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Regulation> previousPage(final Page<Regulation> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Regulation> nextPage(final Page<Regulation> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Regulation> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
