...
public class ConversationReader extends Reader<Conversation> {
    ...
    @Override
    public ResourceSet<Conversation> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Conversation> firstPage(final KandyRestClient client) {
    ...
    private Page<Conversation> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Conversation> previousPage(final Page<Conversation> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Conversation> nextPage(final Page<Conversation> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Conversation> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
