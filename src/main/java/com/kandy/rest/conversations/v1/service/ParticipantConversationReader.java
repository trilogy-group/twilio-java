...
public class ParticipantConversationReader extends Reader<ParticipantConversation> {
    ...
    @Override
    public ResourceSet<ParticipantConversation> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<ParticipantConversation> firstPage(final KandyRestClient client) {
    ...
    private Page<ParticipantConversation> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<ParticipantConversation> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
