...
public class Configuration extends Resource {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(chatServiceSid, defaultConversationCreatorRoleSid, defaultConversationRoleSid,
                defaultChatServiceRoleSid, url, links, reachabilityEnabled);
    }
