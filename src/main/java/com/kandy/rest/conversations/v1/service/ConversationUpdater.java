...
public class ConversationUpdater extends Updater<Conversation> {
    ...
    public ConversationUpdater setXKandyWebhookEnabled(final Conversation.WebhookEnabledType xKandyWebhookEnabled) {
    ...
    @Override
    public Conversation update(final KandyRestClient client) {
