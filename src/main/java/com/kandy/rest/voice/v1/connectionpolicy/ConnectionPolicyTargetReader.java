...
public class ConnectionPolicyTargetReader extends Reader<ConnectionPolicyTarget> {
    ...
    @Override
    public ResourceSet<ConnectionPolicyTarget> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<ConnectionPolicyTarget> firstPage(final KandyRestClient client) {
    ...
    private Page<ConnectionPolicyTarget> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<ConnectionPolicyTarget> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
