...
public class AssetVersionReader extends Reader<AssetVersion> {
    ...
    @Override
    public ResourceSet<AssetVersion> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<AssetVersion> firstPage(final KandyRestClient client) {
    ...
    private Page<AssetVersion> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<AssetVersion> previousPage(final Page<AssetVersion> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<AssetVersion> nextPage(final Page<AssetVersion> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<AssetVersion> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
