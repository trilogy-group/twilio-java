...
public class EnvironmentReader extends Reader<Environment> {
    ...
    @Override
    public ResourceSet<Environment> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Environment> firstPage(final KandyRestClient client) {
    ...
    private Page<Environment> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Environment> previousPage(final Page<Environment> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Environment> nextPage(final Page<Environment> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Environment> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
