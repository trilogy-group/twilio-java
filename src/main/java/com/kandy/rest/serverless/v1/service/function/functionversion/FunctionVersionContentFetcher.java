...
public class FunctionVersionContentFetcher extends Fetcher<FunctionVersionContent> {
    ...
    public FunctionVersionContentFetcher(final String pathServiceSid, final String pathFunctionSid,
    ...
    @Override
    public FunctionVersionContent fetch(final KandyRestClient client) {
