...
public class FunctionVersionReader extends Reader<FunctionVersion> {
    ...
    @Override
    public ResourceSet<FunctionVersion> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<FunctionVersion> firstPage(final KandyRestClient client) {
    ...
    private Page<FunctionVersion> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<FunctionVersion> previousPage(final Page<FunctionVersion> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<FunctionVersion> nextPage(final Page<FunctionVersion> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<FunctionVersion> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
