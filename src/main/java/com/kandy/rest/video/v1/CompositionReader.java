...
public class CompositionReader extends Reader<Composition> {
    ...
    @Override
    public ResourceSet<Composition> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Composition> firstPage(final KandyRestClient client) {
    ...
    private Page<Composition> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Composition> previousPage(final Page<Composition> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Composition> nextPage(final Page<Composition> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Composition> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
