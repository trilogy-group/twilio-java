...
public class PublishedTrackReader extends Reader<PublishedTrack> {
    ...
    @Override
    public ResourceSet<PublishedTrack> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<PublishedTrack> firstPage(final KandyRestClient client) {
    ...
    private Page<PublishedTrack> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<PublishedTrack> previousPage(final Page<PublishedTrack> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<PublishedTrack> nextPage(final Page<PublishedTrack> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<PublishedTrack> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
