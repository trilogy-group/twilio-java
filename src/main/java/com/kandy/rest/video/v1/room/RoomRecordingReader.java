...
public class RoomRecordingReader extends Reader<RoomRecording> {
    ...
    @Override
    public ResourceSet<RoomRecording> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<RoomRecording> firstPage(final KandyRestClient client) {
    ...
    private Page<RoomRecording> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<RoomRecording> previousPage(final Page<RoomRecording> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<RoomRecording> nextPage(final Page<RoomRecording> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<RoomRecording> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
