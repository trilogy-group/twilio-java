...
public class DeviceSecretReader extends Reader<DeviceSecret> {
    ...
    @Override
    public ResourceSet<DeviceSecret> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<DeviceSecret> firstPage(final KandyRestClient client) {
    ...
    private Page<DeviceSecret> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<DeviceSecret> previousPage(final Page<DeviceSecret> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<DeviceSecret> nextPage(final Page<DeviceSecret> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<DeviceSecret> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
