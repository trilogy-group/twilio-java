...
public class OriginationUrlReader extends Reader<OriginationUrl> {
    ...
    @Override
    public ResourceSet<OriginationUrl> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<OriginationUrl> firstPage(final KandyRestClient client) {
    ...
    private Page<OriginationUrl> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<OriginationUrl> previousPage(final Page<OriginationUrl> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<OriginationUrl> nextPage(final Page<OriginationUrl> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<OriginationUrl> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
