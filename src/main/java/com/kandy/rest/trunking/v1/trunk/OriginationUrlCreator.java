...
public class OriginationUrlCreator extends Creator<OriginationUrl> {
    ...
    public OriginationUrlCreator(final String pathTrunkSid, final Integer weight, final Integer priority,
    ...
    @Override
    public OriginationUrl create(final KandyRestClient client) {
