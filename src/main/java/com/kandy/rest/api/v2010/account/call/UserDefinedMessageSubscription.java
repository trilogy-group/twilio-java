...
public class UserDefinedMessageSubscription extends Resource {
    ...
    public static UserDefinedMessageSubscriptionCreator creator(final String pathAccountSid, final String pathCallSid,
            final URI callback) {
    ...
    public static UserDefinedMessageSubscriptionDeleter deleter(final String pathAccountSid, final String pathCallSid,
            final String pathSid) {
        return new UserDefinedMessageSubscriptionDeleter(pathAccountSid, pathCallSid, pathSid);
    }

    /**
     * Converts a JSON String into a UserDefinedMessageSubscription object using the
     * provided ObjectMapper.
     *
     * @param json         Raw JSON String
     * @param objectMapper Jackson ObjectMapper
     * @return UserDefinedMessageSubscription object represented by the provided
     *         JSON
     */
    ...
    /**
     * Converts a JSON InputStream into a UserDefinedMessageSubscription object
     * using the provided
     * ObjectMapper.
     *
