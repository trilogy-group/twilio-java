...
public class Mobile extends Resource {
    ...
    public static MobileCreator creator(final com.kandy.type.PhoneNumber phoneNumber) {
        return new MobileCreator(phoneNumber);
    }

    public static MobileCreator creator(final String pathAccountSid, final com.kandy.type.PhoneNumber phoneNumber) {
