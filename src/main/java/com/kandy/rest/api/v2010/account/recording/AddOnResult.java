...
public class AddOnResult extends Resource {
    ...
    public static AddOnResultDeleter deleter(final String pathAccountSid, final String pathReferenceSid,
    ...
    public static AddOnResultFetcher fetcher(final String pathAccountSid, final String pathReferenceSid,
            final String pathSid) {
    ...
    public boolean equals(final Object o) {
        ...
        return Objects.equals(sid, other.sid) && Objects.equals(accountSid, other.accountSid)
                && Objects.equals(status, other.status) && Objects.equals(addOnSid, other.addOnSid)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(sid, accountSid, status, addOnSid, addOnConfigurationSid, dateCreated, dateUpdated,
                dateCompleted, referenceSid, subresourceUris);
    }
