...
public class UserDefinedMessage extends Resource {
    ...
    public static UserDefinedMessageCreator creator(final String pathAccountSid, final String pathCallSid,
            final String content) {
        return new UserDefinedMessageCreator(pathAccountSid, pathCallSid, content);
    }

    /**
     * Converts a JSON String into a UserDefinedMessage object using the provided
     * ObjectMapper.
     *
    ...
    /**
     * Converts a JSON InputStream into a UserDefinedMessage object using the
     * provided
     * ObjectMapper.
     *
