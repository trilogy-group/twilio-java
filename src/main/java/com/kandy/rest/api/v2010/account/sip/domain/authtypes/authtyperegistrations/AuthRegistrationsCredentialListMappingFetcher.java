...
public class AuthRegistrationsCredentialListMappingFetcher extends Fetcher<AuthRegistrationsCredentialListMapping> {
    ...
    public AuthRegistrationsCredentialListMappingFetcher(final String pathAccountSid, final String pathDomainSid,
    ...
    @Override
    public AuthRegistrationsCredentialListMapping fetch(final KandyRestClient client) {
