...
public class AddressCreator extends Creator<Address> {
    ...
    public AddressCreator(final String customerName, final String street, final String city, final String region,
            final String postalCode, final String isoCountry) {
    ...
    public AddressCreator(final String pathAccountSid, final String customerName, final String street,
    ...
    @Override
    public Address create(final KandyRestClient client) {
