...
public class AuthCallsIpAccessControlListMappingReader extends Reader<AuthCallsIpAccessControlListMapping> {
    ...
    @Override
    public ResourceSet<AuthCallsIpAccessControlListMapping> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<AuthCallsIpAccessControlListMapping> firstPage(final KandyRestClient client) {
    ...
    private Page<AuthCallsIpAccessControlListMapping> pageForRequest(final KandyRestClient client,
    ...
    @Override
    public Page<AuthCallsIpAccessControlListMapping> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
