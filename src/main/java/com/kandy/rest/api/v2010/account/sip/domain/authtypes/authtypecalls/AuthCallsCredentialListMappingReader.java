...
public class AuthCallsCredentialListMappingReader extends Reader<AuthCallsCredentialListMapping> {
    ...
    @Override
    public ResourceSet<AuthCallsCredentialListMapping> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<AuthCallsCredentialListMapping> firstPage(final KandyRestClient client) {
    ...
    private Page<AuthCallsCredentialListMapping> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<AuthCallsCredentialListMapping> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
