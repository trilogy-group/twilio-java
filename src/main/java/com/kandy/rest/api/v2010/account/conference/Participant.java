...
public class Participant extends Resource {
    ...
    public static ParticipantCreator creator(final String pathConferenceSid, final com.kandy.type.Endpoint from,
            final com.kandy.type.Endpoint to) {
        return new ParticipantCreator(pathConferenceSid, from, to);
    }

    public static ParticipantCreator creator(final String pathAccountSid, final String pathConferenceSid,
            final com.kandy.type.Endpoint from, final com.kandy.type.Endpoint to) {
    ...
    public static ParticipantDeleter deleter(final String pathAccountSid, final String pathConferenceSid,
    ...
    public static ParticipantFetcher fetcher(final String pathAccountSid, final String pathConferenceSid,
            final String pathCallSid) {
    ...
    public static ParticipantUpdater updater(final String pathAccountSid, final String pathConferenceSid,
            final String pathCallSid) {
    ...
    public boolean equals(final Object o) {
        ...
        return Objects.equals(accountSid, other.accountSid) && Objects.equals(callSid, other.callSid)
                && Objects.equals(label, other.label) && Objects.equals(callSidToCoach, other.callSidToCoach)
                && Objects.equals(coaching, other.coaching) && Objects.equals(conferenceSid, other.conferenceSid)
                && Objects.equals(dateCreated, other.dateCreated) && Objects.equals(dateUpdated, other.dateUpdated)
                && Objects.equals(endConferenceOnExit, other.endConferenceOnExit) && Objects.equals(muted, other.muted)
                && Objects.equals(hold, other.hold)
                && Objects.equals(startConferenceOnEnter, other.startConferenceOnEnter)
                && Objects.equals(status, other.status) && Objects.equals(uri, other.uri);
    }

    @Override
    public int hashCode() {
        return Objects.hash(accountSid, callSid, label, callSidToCoach, coaching, conferenceSid, dateCreated,
                dateUpdated, endConferenceOnExit, muted, hold, startConferenceOnEnter, status, uri);
    }
