...
public class PayloadFetcher extends Fetcher<Payload> {
    ...
    public PayloadFetcher(final String pathAccountSid, final String pathReferenceSid, final String pathAddOnResultSid,
    ...
    @Override
    public Payload fetch(final KandyRestClient client) {
