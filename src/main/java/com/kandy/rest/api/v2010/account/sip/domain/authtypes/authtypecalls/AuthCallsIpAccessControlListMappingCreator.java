...
public class AuthCallsIpAccessControlListMappingCreator extends Creator<AuthCallsIpAccessControlListMapping> {
    ...
    public AuthCallsIpAccessControlListMappingCreator(final String pathAccountSid, final String pathDomainSid,
    ...
    @Override
    public AuthCallsIpAccessControlListMapping create(final KandyRestClient client) {
