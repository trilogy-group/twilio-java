...
public class IncomingPhoneNumberReader extends Reader<IncomingPhoneNumber> {
    ...
    public IncomingPhoneNumberReader setPhoneNumber(final com.kandy.type.PhoneNumber phoneNumber) {
    ...
    @Override
    public ResourceSet<IncomingPhoneNumber> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<IncomingPhoneNumber> firstPage(final KandyRestClient client) {
    ...
    private Page<IncomingPhoneNumber> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<IncomingPhoneNumber> previousPage(final Page<IncomingPhoneNumber> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<IncomingPhoneNumber> nextPage(final Page<IncomingPhoneNumber> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<IncomingPhoneNumber> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
