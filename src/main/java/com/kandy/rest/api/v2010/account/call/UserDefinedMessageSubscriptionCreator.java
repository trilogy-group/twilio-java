...
public class UserDefinedMessageSubscriptionCreator extends Creator<UserDefinedMessageSubscription> {
    ...
    public UserDefinedMessageSubscriptionCreator(final String pathAccountSid, final String pathCallSid,
            final URI callback) {
    ...
    @Override
    public UserDefinedMessageSubscription create(final KandyRestClient client) {
