...
public class PaymentUpdater extends Updater<Payment> {
    ...
    public PaymentUpdater(final String pathCallSid, final String pathSid, final String idempotencyKey,
    ...
    public PaymentUpdater(final String pathAccountSid, final String pathCallSid, final String pathSid,
    ...
    @Override
    public Payment update(final KandyRestClient client) {
