...
public class CredentialListMappingReader extends Reader<CredentialListMapping> {
    ...
    @Override
    public ResourceSet<CredentialListMapping> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<CredentialListMapping> firstPage(final KandyRestClient client) {
    ...
    private Page<CredentialListMapping> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<CredentialListMapping> nextPage(final Page<CredentialListMapping> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<CredentialListMapping> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
