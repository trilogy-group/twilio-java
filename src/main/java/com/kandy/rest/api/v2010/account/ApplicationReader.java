...
public class ApplicationReader extends Reader<Application> {
    ...
    @Override
    public ResourceSet<Application> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Application> firstPage(final KandyRestClient client) {
    ...
    private Page<Application> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Application> previousPage(final Page<Application> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Application> nextPage(final Page<Application> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Application> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
