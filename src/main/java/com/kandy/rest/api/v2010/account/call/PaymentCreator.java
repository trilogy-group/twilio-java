...
public class PaymentCreator extends Creator<Payment> {
    ...
    public PaymentCreator(final String pathAccountSid, final String pathCallSid, final String idempotencyKey,
    ...
    @Override
    public Payment create(final KandyRestClient client) {
