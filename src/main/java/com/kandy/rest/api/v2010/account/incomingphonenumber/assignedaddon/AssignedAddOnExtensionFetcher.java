...
public class AssignedAddOnExtensionFetcher extends Fetcher<AssignedAddOnExtension> {
    ...
    public AssignedAddOnExtensionFetcher(final String pathResourceSid, final String pathAssignedAddOnSid,
    ...
    public AssignedAddOnExtensionFetcher(final String pathAccountSid, final String pathResourceSid,
    ...
    @Override
    public AssignedAddOnExtension fetch(final KandyRestClient client) {
