...
public class YearlyReader extends Reader<Yearly> {
    ...
    @Override
    public ResourceSet<Yearly> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Yearly> firstPage(final KandyRestClient client) {
    ...
    private Page<Yearly> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Yearly> previousPage(final Page<Yearly> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Yearly> nextPage(final Page<Yearly> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Yearly> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
