...
public class AuthCallsIpAccessControlListMappingFetcher extends Fetcher<AuthCallsIpAccessControlListMapping> {
    ...
    public AuthCallsIpAccessControlListMappingFetcher(final String pathAccountSid, final String pathDomainSid,
    ...
    @Override
    public AuthCallsIpAccessControlListMapping fetch(final KandyRestClient client) {
