...
public class AssignedAddOnExtensionReader extends Reader<AssignedAddOnExtension> {
    ...
    public AssignedAddOnExtensionReader(final String pathAccountSid, final String pathResourceSid,
    ...
    @Override
    public ResourceSet<AssignedAddOnExtension> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<AssignedAddOnExtension> firstPage(final KandyRestClient client) {
    ...
    private Page<AssignedAddOnExtension> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<AssignedAddOnExtension> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
