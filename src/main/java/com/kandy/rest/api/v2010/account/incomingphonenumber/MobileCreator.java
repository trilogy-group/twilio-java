...
public class MobileCreator extends Creator<Mobile> {
    ...
    public MobileCreator(final com.kandy.type.PhoneNumber phoneNumber) {
        this.phoneNumber = phoneNumber;
    }

    public MobileCreator(final String pathAccountSid, final com.kandy.type.PhoneNumber phoneNumber) {
        this.pathAccountSid = pathAccountSid;
        this.phoneNumber = phoneNumber;
    }

    public MobileCreator setPhoneNumber(final com.kandy.type.PhoneNumber phoneNumber) {
        this.phoneNumber = phoneNumber;
        return this;
    }
    ...
    @Override
    public Mobile create(final KandyRestClient client) {
