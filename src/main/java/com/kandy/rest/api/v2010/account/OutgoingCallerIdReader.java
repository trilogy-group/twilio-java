...
public class OutgoingCallerIdReader extends Reader<OutgoingCallerId> {
    ...
    public OutgoingCallerIdReader setPhoneNumber(final com.kandy.type.PhoneNumber phoneNumber) {
    ...
    @Override
    public ResourceSet<OutgoingCallerId> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<OutgoingCallerId> firstPage(final KandyRestClient client) {
    ...
    private Page<OutgoingCallerId> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<OutgoingCallerId> previousPage(final Page<OutgoingCallerId> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<OutgoingCallerId> nextPage(final Page<OutgoingCallerId> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<OutgoingCallerId> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
