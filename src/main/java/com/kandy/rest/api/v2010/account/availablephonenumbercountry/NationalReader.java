...
public class NationalReader extends Reader<National> {
    ...
    public NationalReader setNearNumber(final com.kandy.type.PhoneNumber nearNumber) {
    ...
    @Override
    public ResourceSet<National> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<National> firstPage(final KandyRestClient client) {
    ...
    private Page<National> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<National> previousPage(final Page<National> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<National> nextPage(final Page<National> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<National> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
