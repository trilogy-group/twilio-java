...
public class AuthCallsCredentialListMappingFetcher extends Fetcher<AuthCallsCredentialListMapping> {
    ...
    public AuthCallsCredentialListMappingFetcher(final String pathAccountSid, final String pathDomainSid,
    ...
    @Override
    public AuthCallsCredentialListMapping fetch(final KandyRestClient client) {
