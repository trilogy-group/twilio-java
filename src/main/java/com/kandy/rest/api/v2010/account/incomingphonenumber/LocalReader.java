...
public class LocalReader extends Reader<Local> {
    ...
    public LocalReader setPhoneNumber(final com.kandy.type.PhoneNumber phoneNumber) {
    ...
    @Override
    public ResourceSet<Local> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Local> firstPage(final KandyRestClient client) {
    ...
    private Page<Local> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Local> previousPage(final Page<Local> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Local> nextPage(final Page<Local> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Local> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
