...
public class CallCreator extends Creator<Call> {
    private com.kandy.type.Endpoint to;
    private com.kandy.type.Endpoint from;
    ...
    public CallCreator(final com.kandy.type.Endpoint to, final com.kandy.type.Endpoint from, final URI url) {
        this.to = to;
        this.from = from;
        this.url = url;
    }

    public CallCreator(final String pathAccountSid, final com.kandy.type.Endpoint to,
    ...
    public CallCreator(final com.kandy.type.Endpoint to, final com.kandy.type.Endpoint from,
    ...
    public CallCreator setTo(final com.kandy.type.Endpoint to) {
        this.to = to;
        return this;
    }

    public CallCreator setFrom(final com.kandy.type.Endpoint from) {
        this.from = from;
        return this;
    }
    ...
    public CallCreator setTwiml(final com.kandy.type.Twiml twiml) {
        this.twiml = twiml;
        return this;
    }
    ...
    @Override
    public Call create(final KandyRestClient client) {
