...
public class PayloadReader extends Reader<Payload> {
    ...
    @Override
    public ResourceSet<Payload> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Payload> firstPage(final KandyRestClient client) {
    ...
    private Page<Payload> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Payload> previousPage(final Page<Payload> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Payload> nextPage(final Page<Payload> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Payload> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
