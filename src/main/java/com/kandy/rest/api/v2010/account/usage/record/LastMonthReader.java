...
public class LastMonthReader extends Reader<LastMonth> {
    ...
    @Override
    public ResourceSet<LastMonth> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<LastMonth> firstPage(final KandyRestClient client) {
    ...
    private Page<LastMonth> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<LastMonth> previousPage(final Page<LastMonth> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<LastMonth> nextPage(final Page<LastMonth> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<LastMonth> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
