...
public class RecordReader extends Reader<Record> {
    ...
    @Override
    public ResourceSet<Record> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Record> firstPage(final KandyRestClient client) {
    ...
    private Page<Record> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Record> previousPage(final Page<Record> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Record> nextPage(final Page<Record> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Record> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
