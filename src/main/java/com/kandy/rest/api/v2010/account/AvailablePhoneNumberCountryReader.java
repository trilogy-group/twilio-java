...
public class AvailablePhoneNumberCountryReader extends Reader<AvailablePhoneNumberCountry> {
    ...
    @Override
    public ResourceSet<AvailablePhoneNumberCountry> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<AvailablePhoneNumberCountry> firstPage(final KandyRestClient client) {
    ...
    private Page<AvailablePhoneNumberCountry> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<AvailablePhoneNumberCountry> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
