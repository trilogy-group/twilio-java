...
public class AuthorizedConnectAppReader extends Reader<AuthorizedConnectApp> {
    ...
    @Override
    public ResourceSet<AuthorizedConnectApp> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<AuthorizedConnectApp> firstPage(final KandyRestClient client) {
    ...
    private Page<AuthorizedConnectApp> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<AuthorizedConnectApp> nextPage(final Page<AuthorizedConnectApp> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<AuthorizedConnectApp> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
