...
public class ParticipantCreator extends Creator<Participant> {
    ...
    public ParticipantCreator(final String pathConferenceSid, final com.kandy.type.Endpoint from,
    ...
    public ParticipantCreator(final String pathAccountSid, final String pathConferenceSid,
    ...
    public ParticipantCreator setFrom(final com.kandy.type.Endpoint from) {
        this.from = from;
        return this;
    }

    public ParticipantCreator setTo(final com.kandy.type.Endpoint to) {
        this.to = to;
        return this;
    }
