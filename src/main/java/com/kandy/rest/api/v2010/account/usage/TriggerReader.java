...
public class TriggerReader extends Reader<Trigger> {
    ...
    @Override
    public ResourceSet<Trigger> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Trigger> firstPage(final KandyRestClient client) {
    ...
    private Page<Trigger> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Trigger> previousPage(final Page<Trigger> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Trigger> nextPage(final Page<Trigger> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Trigger> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
