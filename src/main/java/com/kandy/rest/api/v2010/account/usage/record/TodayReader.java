...
public class TodayReader extends Reader<Today> {
    ...
    @Override
    public ResourceSet<Today> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Today> firstPage(final KandyRestClient client) {
    ...
    private Page<Today> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Today> previousPage(final Page<Today> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Today> nextPage(final Page<Today> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Today> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
