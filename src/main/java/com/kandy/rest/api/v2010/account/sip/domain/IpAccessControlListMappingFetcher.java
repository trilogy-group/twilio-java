...
public class IpAccessControlListMappingFetcher extends Fetcher<IpAccessControlListMapping> {
    ...
    public IpAccessControlListMappingFetcher(final String pathAccountSid, final String pathDomainSid,
    ...
    @Override
    public IpAccessControlListMapping fetch(final KandyRestClient client) {
