...
public class MachineToMachineReader extends Reader<MachineToMachine> {
    ...
    public MachineToMachineReader setNearNumber(final com.kandy.type.PhoneNumber nearNumber) {
    ...
    @Override
    public ResourceSet<MachineToMachine> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<MachineToMachine> firstPage(final KandyRestClient client) {
    ...
    private Page<MachineToMachine> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<MachineToMachine> previousPage(final Page<MachineToMachine> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<MachineToMachine> nextPage(final Page<MachineToMachine> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<MachineToMachine> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
