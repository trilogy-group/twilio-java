...
public class MessageCreator extends Creator<Message> {
    ...
    public MessageCreator(final com.kandy.type.PhoneNumber to, final com.kandy.type.PhoneNumber from,
            final String body) {
        this.to = to;
        this.from = from;
        this.body = body;
    ...
    public MessageCreator(final String pathAccountSid, final com.kandy.type.PhoneNumber to,
    ...
    public MessageCreator(final com.kandy.type.PhoneNumber to, final String messagingServiceSid, final String body) {
        this.to = to;
    ...
    public MessageCreator(final com.kandy.type.PhoneNumber to, final String messagingServiceSid,
            final List<URI> mediaUrl) {
        this.to = to;
        this.messagingServiceSid = messagingServiceSid;
        this.mediaUrl = mediaUrl;
    ...
    public MessageCreator setTo(final com.kandy.type.PhoneNumber to) {
        this.to = to;
        return this;
    }
    ...
    public MessageCreator setFrom(final com.kandy.type.PhoneNumber from) {
        this.from = from;
        return this;
    }
