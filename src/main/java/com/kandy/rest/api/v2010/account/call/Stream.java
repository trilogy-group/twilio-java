...
public class Stream extends Resource {
    ...
    public static StreamUpdater updater(final String pathCallSid, final String pathSid,
            final Stream.UpdateStatus status) {
        return new StreamUpdater(pathCallSid, pathSid, status);
    }

    public static StreamUpdater updater(final String pathAccountSid, final String pathCallSid, final String pathSid,
            final Stream.UpdateStatus status) {
