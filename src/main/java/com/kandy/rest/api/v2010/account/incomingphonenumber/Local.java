...
public class Local extends Resource {
    ...
    public static LocalCreator creator(final com.kandy.type.PhoneNumber phoneNumber) {
        return new LocalCreator(phoneNumber);
    }

    public static LocalCreator creator(final String pathAccountSid, final com.kandy.type.PhoneNumber phoneNumber) {
