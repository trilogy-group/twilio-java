...
public class SharedCostReader extends Reader<SharedCost> {
    ...
    public SharedCostReader setNearNumber(final com.kandy.type.PhoneNumber nearNumber) {
    ...
    @Override
    public ResourceSet<SharedCost> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<SharedCost> firstPage(final KandyRestClient client) {
    ...
    private Page<SharedCost> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<SharedCost> previousPage(final Page<SharedCost> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<SharedCost> nextPage(final Page<SharedCost> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<SharedCost> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
