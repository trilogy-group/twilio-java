...
public class DailyReader extends Reader<Daily> {
    ...
    @Override
    public ResourceSet<Daily> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Daily> firstPage(final KandyRestClient client) {
    ...
    private Page<Daily> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Daily> previousPage(final Page<Daily> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Daily> nextPage(final Page<Daily> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Daily> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
