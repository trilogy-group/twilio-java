...
public class AddressReader extends Reader<Address> {
    ...
    @Override
    public ResourceSet<Address> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Address> firstPage(final KandyRestClient client) {
    ...
    private Page<Address> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Address> previousPage(final Page<Address> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Address> nextPage(final Page<Address> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Address> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
