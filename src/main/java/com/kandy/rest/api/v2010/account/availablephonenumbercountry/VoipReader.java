...
public class VoipReader extends Reader<Voip> {
    ...
    public VoipReader setNearNumber(final com.kandy.type.PhoneNumber nearNumber) {
    ...
    @Override
    public ResourceSet<Voip> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Voip> firstPage(final KandyRestClient client) {
    ...
    private Page<Voip> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Voip> previousPage(final Page<Voip> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Voip> nextPage(final Page<Voip> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Voip> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
