...
public class CallReader extends Reader<Call> {
    ...
    public CallReader setTo(final com.kandy.type.PhoneNumber to) {
        this.to = to;
        return this;
    }
    ...
    public CallReader setFrom(final com.kandy.type.PhoneNumber from) {
        this.from = from;
        return this;
    }
    ...
    @Override
    public ResourceSet<Call> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Call> firstPage(final KandyRestClient client) {
    ...
    private Page<Call> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Call> previousPage(final Page<Call> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Call> nextPage(final Page<Call> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Call> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
    ...
    private void addQueryParams(final Request request) {
        ...
        if (startTime != null) {
            request.addQueryParam("StartTime",
                    startTime.format(DateTimeFormatter.ofPattern(Request.QUERY_STRING_DATE_TIME_FORMAT)));
        } else if (startTimeAfter != null || startTimeBefore != null) {
            request.addQueryDateTimeRange("StartTime", startTimeAfter, startTimeBefore);
        }
        if (endTime != null) {
            request.addQueryParam("EndTime",
                    endTime.format(DateTimeFormatter.ofPattern(Request.QUERY_STRING_DATE_TIME_FORMAT)));
