...
public class MonthlyReader extends Reader<Monthly> {
    ...
    @Override
    public ResourceSet<Monthly> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Monthly> firstPage(final KandyRestClient client) {
    ...
    private Page<Monthly> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Monthly> previousPage(final Page<Monthly> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Monthly> nextPage(final Page<Monthly> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Monthly> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
