...
public class AllTimeReader extends Reader<AllTime> {
    ...
    @Override
    public ResourceSet<AllTime> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<AllTime> firstPage(final KandyRestClient client) {
    ...
    private Page<AllTime> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<AllTime> previousPage(final Page<AllTime> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<AllTime> nextPage(final Page<AllTime> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<AllTime> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
