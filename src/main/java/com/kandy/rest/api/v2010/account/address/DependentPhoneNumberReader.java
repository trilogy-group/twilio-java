...
public class DependentPhoneNumberReader extends Reader<DependentPhoneNumber> {
    ...
    @Override
    public ResourceSet<DependentPhoneNumber> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<DependentPhoneNumber> firstPage(final KandyRestClient client) {
    ...
    private Page<DependentPhoneNumber> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<DependentPhoneNumber> nextPage(final Page<DependentPhoneNumber> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<DependentPhoneNumber> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
