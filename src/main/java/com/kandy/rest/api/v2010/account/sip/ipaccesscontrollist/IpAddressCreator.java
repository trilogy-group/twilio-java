...
public class IpAddressCreator extends Creator<IpAddress> {
    ...
    public IpAddressCreator(final String pathIpAccessControlListSid, final String friendlyName,
    ...
    public IpAddressCreator(final String pathAccountSid, final String pathIpAccessControlListSid,
    ...
    @Override
    public IpAddress create(final KandyRestClient client) {
