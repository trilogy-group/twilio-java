...
public class AssignedAddOnReader extends Reader<AssignedAddOn> {
    ...
    @Override
    public ResourceSet<AssignedAddOn> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<AssignedAddOn> firstPage(final KandyRestClient client) {
    ...
    private Page<AssignedAddOn> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<AssignedAddOn> previousPage(final Page<AssignedAddOn> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<AssignedAddOn> nextPage(final Page<AssignedAddOn> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<AssignedAddOn> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
