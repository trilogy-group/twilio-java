...
public class NotificationReader extends Reader<Notification> {
    ...
    @Override
    public ResourceSet<Notification> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Notification> firstPage(final KandyRestClient client) {
    ...
    private Page<Notification> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Notification> previousPage(final Page<Notification> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Notification> nextPage(final Page<Notification> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Notification> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
    ...
    private void addQueryParams(final Request request) {
        ...
        if (messageDate != null) {
            request.addQueryParam("MessageDate",
                    messageDate.format(DateTimeFormatter.ofPattern(Request.QUERY_STRING_DATE_TIME_FORMAT)));
