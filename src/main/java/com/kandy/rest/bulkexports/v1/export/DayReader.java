...
public class DayReader extends Reader<Day> {
    ...
    @Override
    public ResourceSet<Day> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Day> firstPage(final KandyRestClient client) {
    ...
    private Page<Day> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Day> previousPage(final Page<Day> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Day> nextPage(final Page<Day> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Day> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
