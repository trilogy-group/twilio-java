...
public class ExportCustomJobReader extends Reader<ExportCustomJob> {
    ...
    @Override
    public ResourceSet<ExportCustomJob> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<ExportCustomJob> firstPage(final KandyRestClient client) {
    ...
    private Page<ExportCustomJob> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<ExportCustomJob> previousPage(final Page<ExportCustomJob> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<ExportCustomJob> nextPage(final Page<ExportCustomJob> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<ExportCustomJob> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
