...
public class CommandReader extends Reader<Command> {
    ...
    @Override
    public ResourceSet<Command> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Command> firstPage(final KandyRestClient client) {
    ...
    private Page<Command> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Command> previousPage(final Page<Command> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Command> nextPage(final Page<Command> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Command> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
