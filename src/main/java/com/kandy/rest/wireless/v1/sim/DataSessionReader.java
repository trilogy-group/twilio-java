...
public class DataSessionReader extends Reader<DataSession> {
    ...
    @Override
    public ResourceSet<DataSession> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<DataSession> firstPage(final KandyRestClient client) {
    ...
    private Page<DataSession> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<DataSession> previousPage(final Page<DataSession> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<DataSession> nextPage(final Page<DataSession> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<DataSession> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
