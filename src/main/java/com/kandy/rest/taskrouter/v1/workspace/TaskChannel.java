...
public class TaskChannel extends Resource {
    ...
    public static TaskChannelCreator creator(final String pathWorkspaceSid, final String friendlyName,
    ...
    @Override
    public int hashCode() {
        return Objects.hash(accountSid, dateCreated, dateUpdated, friendlyName, sid, uniqueName, workspaceSid,
                channelOptimizedRouting, url, links);
    }
