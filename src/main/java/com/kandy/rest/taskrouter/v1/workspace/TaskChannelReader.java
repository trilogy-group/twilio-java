...
public class TaskChannelReader extends Reader<TaskChannel> {
    ...
    @Override
    public ResourceSet<TaskChannel> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<TaskChannel> firstPage(final KandyRestClient client) {
    ...
    private Page<TaskChannel> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<TaskChannel> previousPage(final Page<TaskChannel> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<TaskChannel> nextPage(final Page<TaskChannel> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<TaskChannel> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
