...
public class WorkflowReader extends Reader<Workflow> {
    ...
    @Override
    public ResourceSet<Workflow> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Workflow> firstPage(final KandyRestClient client) {
    ...
    private Page<Workflow> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Workflow> previousPage(final Page<Workflow> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Workflow> nextPage(final Page<Workflow> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Workflow> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
