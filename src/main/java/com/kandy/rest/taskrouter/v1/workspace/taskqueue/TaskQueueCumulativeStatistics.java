...
public class TaskQueueCumulativeStatistics extends Resource {
    ...
    private TaskQueueCumulativeStatistics(
            ...
            @JsonProperty("split_by_wait_time") final Map<String, Object> splitByWaitTime,
            ...
            @JsonProperty("wait_duration_until_canceled") final Map<String, Object> waitDurationUntilCanceled,

            @JsonProperty("wait_duration_in_queue_until_accepted") final Map<String, Object> waitDurationInQueueUntilAccepted,
    ...
    public boolean equals(final Object o) {
        ...
        return Objects.equals(accountSid, other.accountSid)
                ...
                && Objects.equals(tasksDeleted, other.tasksDeleted) && Objects.equals(tasksEntered, other.tasksEntered)
                && Objects.equals(tasksMoved, other.tasksMoved) && Objects.equals(workspaceSid, other.workspaceSid)
                && Objects.equals(url, other.url);
    }

    @Override
    public int hashCode() {
        return Objects.hash(accountSid, avgTaskAcceptanceTime, startTime, endTime, reservationsCreated,
                reservationsAccepted, reservationsRejected, reservationsTimedOut, reservationsCanceled,
                reservationsRescinded, splitByWaitTime, taskQueueSid, waitDurationUntilAccepted,
                waitDurationUntilCanceled, waitDurationInQueueUntilAccepted, tasksCanceled, tasksCompleted,
                tasksDeleted, tasksEntered, tasksMoved, workspaceSid, url);
    }
