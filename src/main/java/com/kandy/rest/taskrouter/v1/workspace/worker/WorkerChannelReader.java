...
public class WorkerChannelReader extends Reader<WorkerChannel> {
    ...
    @Override
    public ResourceSet<WorkerChannel> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<WorkerChannel> firstPage(final KandyRestClient client) {
    ...
    private Page<WorkerChannel> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<WorkerChannel> previousPage(final Page<WorkerChannel> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<WorkerChannel> nextPage(final Page<WorkerChannel> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<WorkerChannel> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
