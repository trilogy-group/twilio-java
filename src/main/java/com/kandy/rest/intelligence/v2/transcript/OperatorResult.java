...
public class OperatorResult extends Resource {
    ...
    /**
     * Converts a JSON String into a OperatorResult object using the provided
     * ObjectMapper.
     *
    ...
    private OperatorResult(
            ...
            @JsonProperty("utterance_results") final List<Map<String, Object>> utteranceResults,
            ...
            @JsonProperty("label_probabilities") final Map<String, Object> labelProbabilities,

            @JsonProperty("extract_results") final Map<String, Object> extractResults,
    ...
    public boolean equals(final Object o) {
        ...
        return Objects.equals(operatorType, other.operatorType) && Objects.equals(name, other.name)
                && Objects.equals(operatorSid, other.operatorSid) && Objects.equals(extractMatch, other.extractMatch)
                ...
                && Objects.equals(transcriptSid, other.transcriptSid) && Objects.equals(url, other.url);
    }

    @Override
    public int hashCode() {
        return Objects.hash(operatorType, name, operatorSid, extractMatch, matchProbability, normalizedResult,
                utteranceResults, utteranceMatch, predictedLabel, predictedProbability, labelProbabilities,
                extractResults, transcriptSid, url);
    }
