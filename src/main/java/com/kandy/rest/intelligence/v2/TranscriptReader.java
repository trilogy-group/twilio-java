...
public class TranscriptReader extends Reader<Transcript> {
    ...
    @Override
    public ResourceSet<Transcript> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Transcript> firstPage(final KandyRestClient client) {
    ...
    private Page<Transcript> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Transcript> previousPage(final Page<Transcript> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Transcript> nextPage(final Page<Transcript> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Transcript> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
