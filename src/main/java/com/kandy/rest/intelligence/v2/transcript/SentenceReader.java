...
public class SentenceReader extends Reader<Sentence> {
    ...
    @Override
    public ResourceSet<Sentence> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Sentence> firstPage(final KandyRestClient client) {
    ...
    private Page<Sentence> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Sentence> previousPage(final Page<Sentence> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Sentence> nextPage(final Page<Sentence> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Sentence> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
