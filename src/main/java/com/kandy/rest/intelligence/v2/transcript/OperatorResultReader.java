...
public class OperatorResultReader extends Reader<OperatorResult> {
    ...
    @Override
    public ResourceSet<OperatorResult> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<OperatorResult> firstPage(final KandyRestClient client) {
    ...
    private Page<OperatorResult> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<OperatorResult> previousPage(final Page<OperatorResult> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<OperatorResult> nextPage(final Page<OperatorResult> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<OperatorResult> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
