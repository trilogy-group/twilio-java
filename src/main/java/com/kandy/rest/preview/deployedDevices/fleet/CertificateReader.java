...
public class CertificateReader extends Reader<Certificate> {
    ...
    @Override
    public ResourceSet<Certificate> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Certificate> firstPage(final KandyRestClient client) {
    ...
    private Page<Certificate> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Certificate> previousPage(final Page<Certificate> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Certificate> nextPage(final Page<Certificate> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Certificate> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
