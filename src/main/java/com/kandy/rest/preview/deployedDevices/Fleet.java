...
public class Fleet extends Resource {
    ...
    private Fleet(
            ...
            @JsonProperty("default_deployment_sid") final String defaultDeploymentSid,
    ...
    @Override
    public int hashCode() {
        return Objects.hash(sid, url, uniqueName, friendlyName, accountSid, defaultDeploymentSid, dateCreated,
                dateUpdated, links);
    }
