...
public class KeyReader extends Reader<Key> {
    ...
    @Override
    public ResourceSet<Key> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Key> firstPage(final KandyRestClient client) {
    ...
    private Page<Key> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Key> previousPage(final Page<Key> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Key> nextPage(final Page<Key> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Key> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
