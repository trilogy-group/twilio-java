...
public class SyncMapReader extends Reader<SyncMap> {
    ...
    @Override
    public ResourceSet<SyncMap> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<SyncMap> firstPage(final KandyRestClient client) {
    ...
    private Page<SyncMap> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<SyncMap> previousPage(final Page<SyncMap> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<SyncMap> nextPage(final Page<SyncMap> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<SyncMap> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
