...
public class SyncListItemReader extends Reader<SyncListItem> {
    ...
    @Override
    public ResourceSet<SyncListItem> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<SyncListItem> firstPage(final KandyRestClient client) {
    ...
    private Page<SyncListItem> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<SyncListItem> previousPage(final Page<SyncListItem> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<SyncListItem> nextPage(final Page<SyncListItem> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<SyncListItem> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
