...
public class SyncListPermissionUpdater extends Updater<SyncListPermission> {
    ...
    public SyncListPermissionUpdater(final String pathServiceSid, final String pathListSid, final String pathIdentity,
    ...
    @Override
    public SyncListPermission update(final KandyRestClient client) {
