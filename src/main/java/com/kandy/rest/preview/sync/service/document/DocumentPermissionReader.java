...
public class DocumentPermissionReader extends Reader<DocumentPermission> {
    ...
    @Override
    public ResourceSet<DocumentPermission> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<DocumentPermission> firstPage(final KandyRestClient client) {
    ...
    private Page<DocumentPermission> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<DocumentPermission> previousPage(final Page<DocumentPermission> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<DocumentPermission> nextPage(final Page<DocumentPermission> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<DocumentPermission> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
