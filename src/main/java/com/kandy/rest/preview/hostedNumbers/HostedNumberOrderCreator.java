...
public class HostedNumberOrderCreator extends Creator<HostedNumberOrder> {
    ...
    public HostedNumberOrderCreator(final com.kandy.type.PhoneNumber phoneNumber, final Boolean smsCapability) {
        this.phoneNumber = phoneNumber;
        this.smsCapability = smsCapability;
    }

    public HostedNumberOrderCreator setPhoneNumber(final com.kandy.type.PhoneNumber phoneNumber) {
        this.phoneNumber = phoneNumber;
        return this;
    }
    ...
    @Override
    public HostedNumberOrder create(final KandyRestClient client) {
