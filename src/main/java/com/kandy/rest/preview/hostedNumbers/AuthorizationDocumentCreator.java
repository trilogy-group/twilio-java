...
public class AuthorizationDocumentCreator extends Creator<AuthorizationDocument> {
    ...
    public AuthorizationDocumentCreator(final List<String> hostedNumberOrderSids, final String addressSid,
            final String email, final String contactTitle, final String contactPhoneNumber) {
    ...
    @Override
    public AuthorizationDocument create(final KandyRestClient client) {
