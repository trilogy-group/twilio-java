...
public class InstalledAddOnExtensionReader extends Reader<InstalledAddOnExtension> {
    ...
    @Override
    public ResourceSet<InstalledAddOnExtension> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<InstalledAddOnExtension> firstPage(final KandyRestClient client) {
    ...
    private Page<InstalledAddOnExtension> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<InstalledAddOnExtension> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
