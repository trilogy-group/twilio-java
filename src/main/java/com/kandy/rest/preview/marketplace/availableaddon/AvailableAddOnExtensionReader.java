...
package com.kandy.rest.preview.marketplace.availableaddon;
...
public class AvailableAddOnExtensionReader extends Reader<AvailableAddOnExtension> {
    ...
    @Override
    public ResourceSet<AvailableAddOnExtension> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<AvailableAddOnExtension> firstPage(final KandyRestClient client) {
    ...
    private Page<AvailableAddOnExtension> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<AvailableAddOnExtension> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
