...
public class InstalledAddOnExtensionUpdater extends Updater<InstalledAddOnExtension> {
    ...
    public InstalledAddOnExtensionUpdater(final String pathInstalledAddOnSid, final String pathSid,
    ...
    @Override
    public InstalledAddOnExtension update(final KandyRestClient client) {
