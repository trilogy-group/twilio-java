...
public class FieldReader extends Reader<Field> {
    ...
    @Override
    public ResourceSet<Field> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Field> firstPage(final KandyRestClient client) {
    ...
    private Page<Field> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Field> previousPage(final Page<Field> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Field> nextPage(final Page<Field> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Field> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
