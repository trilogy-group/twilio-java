...
public class SampleReader extends Reader<Sample> {
    ...
    @Override
    public ResourceSet<Sample> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Sample> firstPage(final KandyRestClient client) {
    ...
    private Page<Sample> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Sample> previousPage(final Page<Sample> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Sample> nextPage(final Page<Sample> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Sample> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
