...
public class ModelBuildReader extends Reader<ModelBuild> {
    ...
    @Override
    public ResourceSet<ModelBuild> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<ModelBuild> firstPage(final KandyRestClient client) {
    ...
    private Page<ModelBuild> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<ModelBuild> previousPage(final Page<ModelBuild> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<ModelBuild> nextPage(final Page<ModelBuild> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<ModelBuild> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
