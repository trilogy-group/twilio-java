...
public class FieldValueCreator extends Creator<FieldValue> {
    ...
    public FieldValueCreator(final String pathAssistantSid, final String pathFieldTypeSid, final String language,
            final String value) {
    ...
    @Override
    public FieldValue create(final KandyRestClient client) {
