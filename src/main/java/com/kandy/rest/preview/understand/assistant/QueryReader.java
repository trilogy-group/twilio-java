...
public class QueryReader extends Reader<Query> {
    ...
    @Override
    public ResourceSet<Query> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Query> firstPage(final KandyRestClient client) {
    ...
    private Page<Query> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Query> previousPage(final Page<Query> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Query> nextPage(final Page<Query> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Query> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
