...
public class FieldValueReader extends Reader<FieldValue> {
    ...
    @Override
    public ResourceSet<FieldValue> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<FieldValue> firstPage(final KandyRestClient client) {
    ...
    private Page<FieldValue> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<FieldValue> previousPage(final Page<FieldValue> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<FieldValue> nextPage(final Page<FieldValue> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<FieldValue> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
