...
public class MediaProcessorReader extends Reader<MediaProcessor> {
    ...
    @Override
    public ResourceSet<MediaProcessor> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<MediaProcessor> firstPage(final KandyRestClient client) {
    ...
    private Page<MediaProcessor> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<MediaProcessor> previousPage(final Page<MediaProcessor> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<MediaProcessor> nextPage(final Page<MediaProcessor> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<MediaProcessor> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
