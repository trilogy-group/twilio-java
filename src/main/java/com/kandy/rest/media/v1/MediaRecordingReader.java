...
public class MediaRecordingReader extends Reader<MediaRecording> {
    ...
    @Override
    public ResourceSet<MediaRecording> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<MediaRecording> firstPage(final KandyRestClient client) {
    ...
    private Page<MediaRecording> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<MediaRecording> previousPage(final Page<MediaRecording> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<MediaRecording> nextPage(final Page<MediaRecording> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<MediaRecording> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
