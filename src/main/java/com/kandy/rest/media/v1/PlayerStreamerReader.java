...
public class PlayerStreamerReader extends Reader<PlayerStreamer> {
    ...
    @Override
    public ResourceSet<PlayerStreamer> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<PlayerStreamer> firstPage(final KandyRestClient client) {
    ...
    private Page<PlayerStreamer> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<PlayerStreamer> previousPage(final Page<PlayerStreamer> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<PlayerStreamer> nextPage(final Page<PlayerStreamer> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<PlayerStreamer> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
