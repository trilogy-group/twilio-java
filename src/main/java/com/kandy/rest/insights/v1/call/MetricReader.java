...
public class MetricReader extends Reader<Metric> {
    ...
    public MetricReader setEdge(final Metric.KandyEdge edge) {
        this.edge = edge;
        return this;
    }
    ...
    @Override
    public ResourceSet<Metric> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Metric> firstPage(final KandyRestClient client) {
    ...
    private Page<Metric> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Metric> previousPage(final Page<Metric> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Metric> nextPage(final Page<Metric> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Metric> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
