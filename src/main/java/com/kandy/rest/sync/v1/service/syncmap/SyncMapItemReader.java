...
public class SyncMapItemReader extends Reader<SyncMapItem> {
    ...
    @Override
    public ResourceSet<SyncMapItem> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<SyncMapItem> firstPage(final KandyRestClient client) {
    ...
    private Page<SyncMapItem> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<SyncMapItem> previousPage(final Page<SyncMapItem> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<SyncMapItem> nextPage(final Page<SyncMapItem> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<SyncMapItem> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
