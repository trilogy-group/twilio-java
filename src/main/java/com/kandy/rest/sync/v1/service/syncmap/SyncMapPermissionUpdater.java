...
public class SyncMapPermissionUpdater extends Updater<SyncMapPermission> {
    ...
    public SyncMapPermissionUpdater(final String pathServiceSid, final String pathMapSid, final String pathIdentity,
            final Boolean read, final Boolean write, final Boolean manage) {
    ...
    @Override
    public SyncMapPermission update(final KandyRestClient client) {
