...
public class NewFactorCreator extends Creator<NewFactor> {
    ...
    public NewFactorCreator(final String pathServiceSid, final String pathIdentity, final String friendlyName,
    ...
    @Override
    public NewFactor create(final KandyRestClient client) {
