...
public class MessagingConfigurationUpdater extends Updater<MessagingConfiguration> {
    ...
    public MessagingConfigurationUpdater(final String pathServiceSid, final String pathCountry,
    ...
    @Override
    public MessagingConfiguration update(final KandyRestClient client) {
