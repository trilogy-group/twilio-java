...
public class ChallengeReader extends Reader<Challenge> {
    ...
    @Override
    public ResourceSet<Challenge> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Challenge> firstPage(final KandyRestClient client) {
    ...
    private Page<Challenge> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Challenge> previousPage(final Page<Challenge> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Challenge> nextPage(final Page<Challenge> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Challenge> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
