...
public class EntityReader extends Reader<Entity> {
    ...
    @Override
    public ResourceSet<Entity> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Entity> firstPage(final KandyRestClient client) {
    ...
    private Page<Entity> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Entity> previousPage(final Page<Entity> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Entity> nextPage(final Page<Entity> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Entity> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
