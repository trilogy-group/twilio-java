...
public class BucketReader extends Reader<Bucket> {
    ...
    @Override
    public ResourceSet<Bucket> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Bucket> firstPage(final KandyRestClient client) {
    ...
    private Page<Bucket> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Bucket> previousPage(final Page<Bucket> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Bucket> nextPage(final Page<Bucket> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Bucket> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
