...
public class MessagingConfigurationReader extends Reader<MessagingConfiguration> {
    ...
    @Override
    public ResourceSet<MessagingConfiguration> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<MessagingConfiguration> firstPage(final KandyRestClient client) {
    ...
    private Page<MessagingConfiguration> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<MessagingConfiguration> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
