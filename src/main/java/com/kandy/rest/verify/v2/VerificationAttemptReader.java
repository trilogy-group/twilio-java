...
public class VerificationAttemptReader extends Reader<VerificationAttempt> {
    ...
    @Override
    public ResourceSet<VerificationAttempt> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<VerificationAttempt> firstPage(final KandyRestClient client) {
    ...
    private Page<VerificationAttempt> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<VerificationAttempt> previousPage(final Page<VerificationAttempt> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<VerificationAttempt> nextPage(final Page<VerificationAttempt> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<VerificationAttempt> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
