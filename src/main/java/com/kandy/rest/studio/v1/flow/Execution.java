...
public class Execution extends Resource {
    ...
    public static ExecutionCreator creator(final String pathFlowSid, final com.kandy.type.PhoneNumber to,
    ...
    public static ExecutionUpdater updater(final String pathFlowSid, final String pathSid,
    ...
    public boolean equals(final Object o) {
        ...
        return Objects.equals(sid, other.sid) && Objects.equals(accountSid, other.accountSid)
                && Objects.equals(flowSid, other.flowSid) && Objects.equals(contactSid, other.contactSid)
                && Objects.equals(contactChannelAddress, other.contactChannelAddress)
                && Objects.equals(context, other.context) && Objects.equals(status, other.status)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(sid, accountSid, flowSid, contactSid, contactChannelAddress, context, status, dateCreated,
                dateUpdated, url, links);
    }
