...
public class ExecutionStepContextFetcher extends Fetcher<ExecutionStepContext> {
    ...
    public ExecutionStepContextFetcher(final String pathFlowSid, final String pathExecutionSid,
    ...
    @Override
    public ExecutionStepContext fetch(final KandyRestClient client) {
