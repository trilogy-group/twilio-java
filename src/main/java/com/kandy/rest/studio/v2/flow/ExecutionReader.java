...
public class ExecutionReader extends Reader<Execution> {
    ...
    @Override
    public ResourceSet<Execution> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Execution> firstPage(final KandyRestClient client) {
    ...
    private Page<Execution> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Execution> previousPage(final Page<Execution> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Execution> nextPage(final Page<Execution> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Execution> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
