...
package com.kandy.rest.studio.v2.flow.execution;
...
public class ExecutionStepReader extends Reader<ExecutionStep> {
    ...
    @Override
    public ResourceSet<ExecutionStep> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<ExecutionStep> firstPage(final KandyRestClient client) {
    ...
    private Page<ExecutionStep> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<ExecutionStep> previousPage(final Page<ExecutionStep> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<ExecutionStep> nextPage(final Page<ExecutionStep> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<ExecutionStep> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
