...
public class UsAppToPersonCreator extends Creator<UsAppToPerson> {
    ...
    public UsAppToPersonCreator(final String pathMessagingServiceSid, final String brandRegistrationSid,
    ...
    @Override
    public UsAppToPerson create(final KandyRestClient client) {
