...
public class LinkshorteningMessagingServiceDomainAssociation extends Resource {
    ...
    /**
     * Converts a JSON String into a LinkshorteningMessagingServiceDomainAssociation
     * object using the provided ObjectMapper.
     *
     * @param json         Raw JSON String
     * @param objectMapper Jackson ObjectMapper
     * @return LinkshorteningMessagingServiceDomainAssociation object represented by
     *         the provided JSON
     */
    public static LinkshorteningMessagingServiceDomainAssociation fromJson(final String json,
    ...
    /**
     * Converts a JSON InputStream into a
     * LinkshorteningMessagingServiceDomainAssociation object using the provided
     * ObjectMapper.
     *
     ...
     *         the provided JSON
     */
    public static LinkshorteningMessagingServiceDomainAssociation fromJson(final InputStream json,
            final ObjectMapper objectMapper) {
        // Convert all checked exceptions to Runtime
        try {
            return objectMapper.readValue(json, LinkshorteningMessagingServiceDomainAssociation.class);
