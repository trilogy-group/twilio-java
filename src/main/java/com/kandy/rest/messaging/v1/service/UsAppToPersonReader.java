...
public class UsAppToPersonReader extends Reader<UsAppToPerson> {
    ...
    @Override
    public ResourceSet<UsAppToPerson> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<UsAppToPerson> firstPage(final KandyRestClient client) {
    ...
    private Page<UsAppToPerson> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<UsAppToPerson> previousPage(final Page<UsAppToPerson> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<UsAppToPerson> nextPage(final Page<UsAppToPerson> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<UsAppToPerson> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
