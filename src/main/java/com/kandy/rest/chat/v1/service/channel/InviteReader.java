...
public class InviteReader extends Reader<Invite> {
    ...
    @Override
    public ResourceSet<Invite> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Invite> firstPage(final KandyRestClient client) {
    ...
    private Page<Invite> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Invite> previousPage(final Page<Invite> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Invite> nextPage(final Page<Invite> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Invite> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
