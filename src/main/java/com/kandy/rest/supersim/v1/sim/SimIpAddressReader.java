...
public class SimIpAddressReader extends Reader<SimIpAddress> {
    ...
    @Override
    public ResourceSet<SimIpAddress> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<SimIpAddress> firstPage(final KandyRestClient client) {
    ...
    private Page<SimIpAddress> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<SimIpAddress> previousPage(final Page<SimIpAddress> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<SimIpAddress> nextPage(final Page<SimIpAddress> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<SimIpAddress> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
