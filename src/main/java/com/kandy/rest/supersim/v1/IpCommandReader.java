...
public class IpCommandReader extends Reader<IpCommand> {
    ...
    @Override
    public ResourceSet<IpCommand> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<IpCommand> firstPage(final KandyRestClient client) {
    ...
    private Page<IpCommand> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<IpCommand> previousPage(final Page<IpCommand> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<IpCommand> nextPage(final Page<IpCommand> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<IpCommand> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
