...
public class NetworkReader extends Reader<Network> {
    ...
    @Override
    public ResourceSet<Network> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Network> firstPage(final KandyRestClient client) {
    ...
    private Page<Network> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Network> previousPage(final Page<Network> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Network> nextPage(final Page<Network> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Network> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
