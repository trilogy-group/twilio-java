...
public class SettingsUpdateReader extends Reader<SettingsUpdate> {
    ...
    @Override
    public ResourceSet<SettingsUpdate> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<SettingsUpdate> firstPage(final KandyRestClient client) {
    ...
    private Page<SettingsUpdate> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<SettingsUpdate> previousPage(final Page<SettingsUpdate> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<SettingsUpdate> nextPage(final Page<SettingsUpdate> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<SettingsUpdate> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
