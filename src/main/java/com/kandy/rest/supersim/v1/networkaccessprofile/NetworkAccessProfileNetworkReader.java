...
public class NetworkAccessProfileNetworkReader extends Reader<NetworkAccessProfileNetwork> {
    ...
    @Override
    public ResourceSet<NetworkAccessProfileNetwork> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<NetworkAccessProfileNetwork> firstPage(final KandyRestClient client) {
    ...
    private Page<NetworkAccessProfileNetwork> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<NetworkAccessProfileNetwork> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
