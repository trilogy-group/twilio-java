...
public class NetworkAccessProfileReader extends Reader<NetworkAccessProfile> {
    ...
    @Override
    public ResourceSet<NetworkAccessProfile> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<NetworkAccessProfile> firstPage(final KandyRestClient client) {
    ...
    private Page<NetworkAccessProfile> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<NetworkAccessProfile> nextPage(final Page<NetworkAccessProfile> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<NetworkAccessProfile> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
