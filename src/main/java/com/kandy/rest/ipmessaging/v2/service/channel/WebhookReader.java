...
public class WebhookReader extends Reader<Webhook> {
    ...
    @Override
    public ResourceSet<Webhook> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Webhook> firstPage(final KandyRestClient client) {
    ...
    private Page<Webhook> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Webhook> previousPage(final Page<Webhook> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Webhook> nextPage(final Page<Webhook> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Webhook> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
