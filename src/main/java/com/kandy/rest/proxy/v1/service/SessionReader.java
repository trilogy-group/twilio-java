...
public class SessionReader extends Reader<Session> {
    ...
    @Override
    public ResourceSet<Session> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Session> firstPage(final KandyRestClient client) {
    ...
    private Page<Session> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Session> previousPage(final Page<Session> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Session> nextPage(final Page<Session> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Session> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
