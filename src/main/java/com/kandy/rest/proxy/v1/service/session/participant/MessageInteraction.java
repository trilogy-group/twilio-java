...
public class MessageInteraction extends Resource {
    ...
    public static MessageInteractionCreator creator(final String pathServiceSid, final String pathSessionSid,
    ...
    public static MessageInteractionFetcher fetcher(final String pathServiceSid, final String pathSessionSid,
    ...
    public static MessageInteractionReader reader(final String pathServiceSid, final String pathSessionSid,
    ...
    @Override
    public int hashCode() {
        return Objects.hash(sid, sessionSid, serviceSid, accountSid, data, type, participantSid, inboundParticipantSid,
