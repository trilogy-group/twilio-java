...
public class InteractionReader extends Reader<Interaction> {
    ...
    @Override
    public ResourceSet<Interaction> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Interaction> firstPage(final KandyRestClient client) {
    ...
    private Page<Interaction> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<Interaction> previousPage(final Page<Interaction> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Interaction> nextPage(final Page<Interaction> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<Interaction> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
