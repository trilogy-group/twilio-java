...
public class MessageInteractionReader extends Reader<MessageInteraction> {
    ...
    public MessageInteractionReader(final String pathServiceSid, final String pathSessionSid,
    ...
    @Override
    public ResourceSet<MessageInteraction> read(final KandyRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<MessageInteraction> firstPage(final KandyRestClient client) {
    ...
    private Page<MessageInteraction> pageForRequest(final KandyRestClient client, final Request request) {
    ...
    @Override
    public Page<MessageInteraction> previousPage(final Page<MessageInteraction> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<MessageInteraction> nextPage(final Page<MessageInteraction> page, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
    ...
    @Override
    public Page<MessageInteraction> getPage(final String targetUrl, final KandyRestClient client) {
        Request request = new Request(
                HttpMethod.GET,
                targetUrl);
