...
public class ValidationToken extends Jwt {
    ...
    public Map<String, Object> getClaims() {
        ...
        String canonicalRequest = new RequestCanonicalizer(method, uri, queryString, requestBody, headers)
    ...
    public static ValidationToken fromHttpRequest(
            ...
            HttpRequest request,
            List<String> signedHeaders) throws IOException {
        ...
        /**
         * If the request encloses an "entity", use it for the body. Note that this is
