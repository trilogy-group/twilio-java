package com.kandy.jwt.validation;

import com.kandy.exception.InvalidRequestException;
...
class RequestCanonicalizer {
    ...
    private static final Pattern TOKEN_REPLACE_PATTERN = Pattern
            .compile(String.format("%s|\\%s|\\%s|%s", "%7E", "+", "*", "%2F"));
    ...
    public String create(List<String> sortedIncludedHeaders) {
        ...
        // Get the query args, replace whitespace and values that should be not encoded,
        // sort and rejoin
     ...
     * <li>Replaces a set of control characters with the values defined in the
     * contract
    ...
    /**
     * Normalizes the headers by setting all of the header keys to lower case and
     * removing default ports from the host.
     */
    ...
    /**
     * Replaces the special characters in the URLEncoded string with the replacement
     * values defined by the spec.
     *
     * Partially copied from https://github.com/aws/aws-sdk-java:
     * com.amazonaws.util.SdkHttpUtils (2017-05-19)
     *
