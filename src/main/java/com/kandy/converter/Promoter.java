package com.kandy.converter;

import com.kandy.type.PhoneNumber;
import com.kandy.type.Twiml;
...
public class Promoter {
    ...
    /**
     * Create a @see com.kandy.types.PhoneNumber from a string
     *
     * @param pn PhoneNumber to convert
     * @return built @see com.kandy.types.PhoneNumber
     */
    ...
    /**
     * Create a @see com.kandy.types.Twiml from a string
     *
     * @param twiml Twiml to convert
     * @return built @see com.kandy.types.Twiml
     */
