package com.kandy.jwt.taskrouter;
...
public class UrlUtilsTest {
    ...
    public void testWorkspace() {
        Assert.assertEquals(
                "https://taskrouter.kandy.com/v1/Workspaces/WS123",
    ...
    public void testTaskQueues() {
        Assert.assertEquals(
                "https://taskrouter.kandy.com/v1/Workspaces/WS123/TaskQueues",
    ...
    public void testTaskQueue() {
        Assert.assertEquals(
                "https://taskrouter.kandy.com/v1/Workspaces/WS123/TaskQueues/TQ123",
    ...
    public void testTasks() {
        Assert.assertEquals(
                "https://taskrouter.kandy.com/v1/Workspaces/WS123/Tasks",
    ...
    public void testTask() {
        Assert.assertEquals(
                "https://taskrouter.kandy.com/v1/Workspaces/WS123/Tasks/TK123",
    ...
    public void testActivities() {
        Assert.assertEquals(
                "https://taskrouter.kandy.com/v1/Workspaces/WS123/Activities",
    ...
    public void testActivity() {
        Assert.assertEquals(
                "https://taskrouter.kandy.com/v1/Workspaces/WS123/Activities/AC123",
    ...
    public void testWorkers() {
        Assert.assertEquals(
                "https://taskrouter.kandy.com/v1/Workspaces/WS123/Workers",
    ...
    public void testWorker() {
        Assert.assertEquals(
                "https://taskrouter.kandy.com/v1/Workspaces/WS123/Workers/WK123",
    ...
    public void testReservations() {
        Assert.assertEquals(
                "https://taskrouter.kandy.com/v1/Workspaces/WS123/Workers/WK123/Reservations",
    ...
    public void testReservation() {
        Assert.assertEquals(
                "https://taskrouter.kandy.com/v1/Workspaces/WS123/Workers/WK123/Reservations/WR123",
