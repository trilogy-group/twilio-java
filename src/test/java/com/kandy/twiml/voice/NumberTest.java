...
public class NumberTest {
    ...
    public void testElementWithParams() {
        Number elem = new Number.Builder(new com.kandy.type.PhoneNumber("+15017122661"))
    ...
    public void testXmlAttributesDeserialization() {
        final Number elem = new Number.Builder(new com.kandy.type.PhoneNumber("+15017122661"))
                .sendDigits("send_digits")
                .url(URI.create("https://example.com"))
                .method(HttpMethod.GET)
                .statusCallbackEvents(Promoter.listOfOne(Number.Event.INITIATED))
