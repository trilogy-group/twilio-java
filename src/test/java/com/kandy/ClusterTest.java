...
import com.kandy.rest.api.v2010.account.IncomingPhoneNumberReader;
import com.kandy.rest.api.v2010.account.Message;
import com.kandy.rest.chat.v2.Service;
import com.kandy.rest.chat.v2.service.User;
import com.kandy.rest.events.v1.Sink;
import com.kandy.rest.events.v1.Subscription;
...
public class ClusterTest {
    ...
    public void testSendingAText() {
        Message message = Message.creator(
                new com.kandy.type.PhoneNumber(toNumber), new com.kandy.type.PhoneNumber(fromNumber),
                "Where's Wallace?")
                .create();
    ...
    public void testListingANumber() {
        IncomingPhoneNumberReader phoneNumberReader = IncomingPhoneNumber.reader();
    ...
    public void testListParams() {
        ...
        types1.put("type", "com.kandy.messaging.message.delivered");
        types2.put("type", "com.kandy.messaging.message.sent");
        types.add(types1);
        types.add(types2);
        ...
        Subscription subscription = Subscription.creator("test subscription java", sink.getSid(), types).create();
