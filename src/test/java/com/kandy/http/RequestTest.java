...
public class RequestTest {
    ...
    public void testRegionInConstructor() {
        ...
        assertUrlsEqual("https://accounts.region.kandy.com/path/to/something.json?foo=12.34#bar",
                request.constructURL());

        request.setEdge("edge");
        assertUrlsEqual("https://accounts.edge.region.kandy.com/path/to/something.json?foo=12.34#bar",
                request.constructURL());
    }
