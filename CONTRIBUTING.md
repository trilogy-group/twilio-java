# Contributing to `kandy-java`

We'd love for you to contribute to our source code and to make `kandy-java`
...
Help us keep `kandy-java` open and inclusive. Please be kind to and considerate
of other developers, as we all have the same goal: make `kandy-java` as good as
it can be.

## <a name="question"></a> Got an API/Product Question or Problem?

If you have questions about how to use `kandy-java`, please see our
...
- **Major Changes** that you wish to contribute to the project should be
  discussed first with `kandy-java` contributors in an issue or pull request so
...
- **`kandy-java` Version(s)** - is it a regression?
...
- Run the full `kandy-java` test suite (aliased by `make test`), and ensure
  that all tests pass.
...
In GitHub, send a pull request to `kandy-java:main`.
If we suggest changes, then:

- Make the required updates.
- Re-run the `kandy-java` test suite to ensure tests are still passing.
...
[issue-link]: https://github.com/kandy/kandy-java/issues/new
[github]: https://github.com/kandy/kandy-java
